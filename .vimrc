...
autocmd FileType cpp :map <F7> i#include<iostream><CR>#include<cstdio><CR>#include<cstdlib><CR>#include<cstring><CR>#include<cmath><CR>#include<string><CR>#include<cctype><CR>#include<climits><CR>#include<algorithm><CR>#include<complex><CR>#include<vector><CR>#include<queue><CR>#include<set><CR>#include<map><CR><CR>using namespace std;<CR><CR>typedef long long LL;<CR><CR><CR><CR>int main() {<CR><CR>freopen("test.in", "r", stdin);<CR>//freopen("test.out", "w", stdout);<CR><CR><CR><CR>return 0;<CR><CR>}<CR><ESC>kkkkkkkkkkkk
...
autocmd FileType perl :map <F5> :!./%<CR>
autocmd FileType perl :map <F4> :!chmod 755 %<CR>
